...
def calcularTesouros(tempo, tesouro):
    ...
    if(tempo <  9 * tesouro[tamanho - 1][0]):
    ...
    memo[tamanho - 1] = max(calcularTesouros(tempo, tesouro[:tamanho - 1]), tesouro[tamanho - 1][1] + calcularTesouros(tempo - 9*tesouro[tamanho - 1][0], tesouro[:tamanho - 1]))
    return memo[tamanho - 1]
